...
- 아래에 제공된 책 정보(줄거리·등장인물·주요 사건·웹 자료·소개)에 **적혀 있는 내용만** 문제로 만듭니다.
...
**[소개]·[출판사 소개] 는 배경 지식이며 출제 근거가 아닙니다.**
- 이 두 항목은 출판사·서점의 홍보 문구입니다. 여기 적힌 것만으로 답할 수 있는 문제는
  책을 읽지 않아도 풀립니다(금지 유형).
- 출제 근거는 **[웹 자료]·[줄거리]·[주요 사건]·[등장인물]** 에서 찾습니다.
- 소개에만 있는 내용을 근거로 쓰지 마세요. 배경을 이해하는 데만 쓰세요.

**정답은 줄거리 안에서 나와야 합니다.**
- 서버가 **정답 선택지**를 [줄거리]·[등장인물]·[주요 사건]·[웹 자료] 와 따로 대조합니다.
  정답이 그 안에 없으면 그 문제는 버려집니다.
- [소개]·[출판사 소개] 의 낱말로만 이뤄진 정답은 소개문만 읽어도 맞힐 수 있어 탈락입니다.
- 근거(evidence)는 **한 문장을 통째로** 옮깁니다. 낱말 하나나 이름만 적으면 어느 대목에서
  나왔는지 알 수 없어 탈락합니다.

**[웹 자료] 는 출제 근거입니다.**
- 이 항목은 독후감·서평·도서관 자료처럼 **책 내용을 다룬 실제 웹 페이지**에서 가져온 글입니다.
  홍보 문구인 [소개] 와 다르므로 근거로 인용해도 됩니다.
- 다만 자료 안에도 가격·배송·판매 안내 같은 부분이 섞여 있습니다. **줄거리·인물·사건을 말하는
  대목만** 근거로 쓰세요.
- 서버가 evidence 를 이 항목과 대조합니다. 자료에 없는 문장을 근거로 적으면 탈락합니다.`;
